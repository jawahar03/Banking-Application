...
public class UserController 
{
	...
	@PostMapping
	public ResponseEntity<ResponseStructure<User>> saveUser(@Valid  @RequestBody User u, @RequestParam int accType, @RequestParam String mName, @RequestParam String password )
	{
